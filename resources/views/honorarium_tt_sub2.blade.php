                        ...
                        @if($kategori->kode_bagian==17)
                          ...
                          <tr>
                            ...
                            <tr>
                                ...
                                <td> 
                                  <i class="fa fa-eye" data-toggle="modal" onclick="submitUpdate2({{ $sub2->id }},{{$sub2->kode_tabel}})" data-target="#show-modal2"> | </i> 
                                  <i class="fa fa-pencil" data-toggle="modal" onclick="submitUpdate2({{ $sub2->id }},{{$sub2->kode_tabel}}) "data-target="#edit-modal2"> </i>
                                </td>
                            </tr>
                            @endforeach
                            @endforeach
